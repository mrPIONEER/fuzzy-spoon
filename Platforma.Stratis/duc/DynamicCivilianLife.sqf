	...
	Актиация:
	[] execVM "duc\DynamicCivilianLife.sqf"
	...
	*/
	...
	generate_zone	= compile preprocessFile "fn\dcl\generate_zone.sqf";
	walk		= compile preprocessFile "fn\dcl\walk.sqf";

	// Классы гражданских. В стандарте от А3
	...
	// АЛТИС. Координаты спавна гражданских x и y
	...
	// кол-во гражданских в одной группе
	DCLgroupsize = 5;

	// дистанция ходьбы гражданских
	DCLdistancemove = 300;
