		...
		[
			...
			"
				...
				_shift = _this select 2;
    				...
    				_alt = _this select 4;
				_returnvalue = _false;
				_actions = [ 'showmap', 'TimeDec', 'TimeInc', 'Gear', 'Throw', 'Fire', 'ReloadMagazine', 'SwitchWeapon', 'Diary', 'MoveLeft', 'MoveRight', 'MoveForward', 'MoveFastForward', 'MoveBack', 'MoveSlowForward', 'ZoomInToggle', 'ZoomOutToggle', 'ZoomIn', 'ZoomOut', 'BuldZoomIn', 'TurnLeft', 'TurnRight', 'TacticalView', 'Tasks', 'TasksToggle' ];
