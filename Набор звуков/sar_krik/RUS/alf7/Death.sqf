...
case 0: {player  say "RUS_alf7_Death_431"};
case 1: {player  say "RUS_alf7_Death_433"};
case 2: { player say "RUS_alf7_Death_434"};
case 3: { player say "RUS_alf7_Death_435"};
case 4: { player say "RUS_alf7_Death_436"};
case 5: { player say "RUS_alf7_Death_437"};
}
};