...
case 0: {_obj say "usa_fired_BRIAN_1"};
case 1: {_obj say "usa_fired_BRIAN_2"};
case 2: {_obj say "usa_fired_BRIAN_3"};
case 3: {_obj say "usa_fired_BRIAN_4"};
case 4: {_obj say "usa_fired_BRIAN_5"};
case 5: {_obj say "usa_fired_BRIAN_6"};
case 6: {_obj say "usa_fired_BRIAN_7"};
case 7: {_obj say "usa_fired_BRIAN_8"};
}
};