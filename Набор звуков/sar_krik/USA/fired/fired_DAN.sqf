...
case 0: {_obj say "usa_fired_DAN_1"};
case 1: {_obj say "usa_fired_DAN_2"};
case 2: {_obj say "usa_fired_DAN_3"};
case 3: {_obj say "usa_fired_DAN_4"};
case 4: {_obj say "usa_fired_DAN_5"};
case 5: {_obj say "usa_fired_DAN_6"};
case 6: {_obj say "usa_fired_DAN_7"};
case 7: {_obj say "usa_fired_DAN_8"};
case 8: {_obj say "usa_fired_DAN_9"};
}
};