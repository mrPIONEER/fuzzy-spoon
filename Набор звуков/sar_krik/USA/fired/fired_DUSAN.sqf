...
case 0: {_obj say "usa_fired_DUSAN_1"};
case 1: {_obj say "usa_fired_DUSAN_2"};
case 2: {_obj say "usa_fired_DUSAN_3"};
case 3: {_obj say "usa_fired_DUSAN_4"};
case 4: {_obj say "usa_fired_DUSAN_5"};
case 5: {_obj say "usa_fired_DUSAN_6"};
case 6: {_obj say "usa_fired_DUSAN_7"};
case 7: {_obj say "usa_fired_DUSAN_8"};
case 8: {_obj say "usa_fired_DUSAN_9"};
}
};