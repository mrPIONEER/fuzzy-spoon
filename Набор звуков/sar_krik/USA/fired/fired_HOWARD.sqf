...
case 0: {_obj say "usa_fired_HOWARD_1"};
case 1: {_obj say "usa_fired_HOWARD_2"};
case 2: {_obj say "usa_fired_HOWARD_3"};
case 3: {_obj say "usa_fired_HOWARD_4"};
case 4: {_obj say "usa_fired_HOWARD_5"};
case 5: {_obj say "usa_fired_HOWARD_6"};
case 6: {_obj say "usa_fired_HOWARD_7"};
case 7: {_obj say "usa_fired_HOWARD_8"};
}
};