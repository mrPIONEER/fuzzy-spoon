...
case 0: {_obj say "usa_fired_MATHEW_1"};
case 1: {_obj say "usa_fired_MATHEW_2"};
case 2: {_obj say "usa_fired_MATHEW_3"};
case 3: {_obj say "usa_fired_MATHEW_4"};
case 4: {_obj say "usa_fired_MATHEW_5"};
case 5: {_obj say "usa_fired_MATHEW_6"};
case 6: {_obj say "usa_fired_MATHEW_7"};
case 7: {_obj say "usa_fired_MATHEW_8"};
}
};