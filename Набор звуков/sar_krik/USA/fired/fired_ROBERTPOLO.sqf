...
case 0: {_obj say "usa_fired_ROBERTPOLO_1"};
case 1: {_obj say "usa_fired_ROBERTPOLO_2"};
case 2: {_obj say "usa_fired_ROBERTPOLO_3"};
case 3: {_obj say "usa_fired_ROBERTPOLO_4"};
case 4: {_obj say "usa_fired_ROBERTPOLO_5"};
case 5: {_obj say "usa_fired_ROBERTPOLO_6"};
case 6: {_obj say "usa_fired_ROBERTPOLO_7"};
case 7: {_obj say "usa_fired_ROBERTPOLO_8"};
case 8: {_obj say "usa_fired_ROBERTPOLO_9"};
}
};