...
case 0: {_obj say "usa_fired_RYAN_1"};
case 1: {_obj say "usa_fired_RYAN_2"};
case 2: {_obj say "usa_fired_RYAN_3"};
case 3: {_obj say "usa_fired_RYAN_4"};
case 4: {_obj say "usa_fired_RYAN_5"};
case 5: {_obj say "usa_fired_RYAN_6"};
case 6: {_obj say "usa_fired_RYAN_7"};
case 7: {_obj say "usa_fired_RYAN_8"};
}
};