...
case 0: {_obj say "usa_hit_JEFF_1"};
case 1: {_obj say "usa_hit_JEFF_2"};
case 2: {_obj say "usa_hit_JEFF_3"};
case 3: {_obj say "usa_hit_JEFF_4"};
case 4: {_obj say "usa_hit_JEFF_5"};
case 5: {_obj say "usa_hit_JEFF_6"};
case 6: {_obj say "usa_hit_JEFF_7"};
case 7: {_obj say "usa_hit_JEFF_8"};
}
};